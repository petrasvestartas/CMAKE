...
# Import target "sortdemo::my_sort_lib" for configuration "Debug"
set_property(TARGET sortdemo::my_sort_lib APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(sortdemo::my_sort_lib PROPERTIES
  IMPORTED_IMPLIB_DEBUG "C:/Program Files/sortdemo/lib/my_sort_lib.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/my_sort_lib.dll"
  )
...
# Import target "sortdemo::my_print_lib" for configuration "Debug"
set_property(TARGET sortdemo::my_print_lib APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(sortdemo::my_print_lib PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/my_print_lib.dll"
  )
